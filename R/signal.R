...
abcdutils_error <- function(..., env = 1) {
    cli::cli_abort(
        message = c(
            x = paste0(
                ...
...
abcdutils_warning <- function(..., env = 1) {
    cli::cli_warn(
        message = c(
            "!" = paste0(
                ...
...
abcdutils_alert <- function(..., env = 1) {
    cli::cli_alert_info(
        text = paste0( ...),
        .envir = rlang::caller_env(env)
    )
...
#'
#' @keywords internal
#' @param version Version of `abcdutils` in which function has been deprecated.
#' @param alternative Recommended alternative approach.
#' @param env Environment to evaluate expressions in.
#' @return Returns no value. Raises a warning through cli::cli_warn.
abcdutils_deprecated <- function(version, alternative, env = 1) {
    cli::cli_warn(
        message = c(
            "!" = paste0(
...
#'
#' @keywords internal
#' @param version Version of `abcdutils` in which function has been made defunct.
#' @param alternative Recommended alternative approach.
#' @param env Environment to evaluate expressions in.
#' @return Returns no value. Raises an error through cli::cli_abort.
abcdutils_defunct <- function(version, alternative, env = 1) {
    cli::cli_abort(
        message = c(
            "!" = paste0(
